...
<head>
    ...
    <link href="{{ asset('theme_css/coreui/icons/css/coreui-icons.min.css') }}" rel="stylesheet">
    <link href="{{ asset('theme_css/coreui/icons/css/coreui-icons.min.css') }}" rel="stylesheet">
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
  ...
  <!-- CoreUI and necessary plugins-->
    ...
    <script src="{{ asset('theme_js/bootstrap/dist/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('theme_js/pace-progress/pace.min.js') }}"></script>
    <script src="{{ asset('theme_js/perfect-scrollbar/dist/perfect-scrollbar.min.js') }}"></script>
    <script src="{{ asset('theme_css/coreui/coreui/dist/js/coreui.min.js') }}"></script>
